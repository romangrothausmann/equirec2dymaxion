...
void conv_ll_t_sc(double lng, double lat, double *theta, double *phi);
...
void convert_s_t_p(double lng, double lat, double *x, double *y)
{
  ...
  //printf("hx %f, hy %f, hz %f, tri %f, hlcd %f\n", hx, hy, hz, tri, hlcd);

  /* Determine the corresponding Fuller map plane (x, y) point */

  dymax_point(tri, hlcd, hx, hy, hz, &px, &py);
  //printf("tri %f, hlcd %f, hx %f, hy %f, hz %f, px %f, py %f\n", tri, hlcd, hx, hy, hz, px, py);
